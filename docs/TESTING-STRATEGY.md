...
| **Offers** (D06) | 80% — state machine (43 tests: all transitions + guards + H4-2 cleanup), AI (14 tests: comp suggest, letter draft, salary check), intent patterns (16 tests), SA CRUD (19 tests), Inngest handlers (15 tests: approval-notify, approval-advanced, check-expiry, withdraw, send-esign stub). Total: 97 offer unit tests + 10 ai_match_explanations RLS. | 44 RLS tests (3 tables × 4 ops × 2 tenants: offer_templates 15, offers 15, offer_approvals 14) | 2 planned scenarios (E2E-06, E2E-07) | Phase 4 |
