...
- **Phase:** Build — **Wave F (Notification Cluster) ✅ COMPLETE. Phase 3 ✅ COMPLETE.**
- **Build order:** Phase 0 ✅ → Phase 1 ✅ → Phase 2 ✅ → Phase 2.5 ✅ → Phase 2.6 ✅ → Phase 2.7 ✅ → Phase 3 ✅ → Wave F ✅ → **Phase 4 (offers) ← NEXT** → Phase 5 (billing)
- **Documentation:** ALL 30 docs complete. Spec docs describe WHAT; build order changed per ADR-011.
- **Test count:** 892 Vitest + 68 E2E = 960 total. All passing.
- **Migrations:** 27 total (000–027). Migration 027 adds email_templates + notification_preferences (Wave F).
