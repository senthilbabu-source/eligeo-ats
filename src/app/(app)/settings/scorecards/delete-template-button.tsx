...
import { deleteScorecardTemplate } from "@/lib/actions/scorecards";
...
export function DeleteScorecardTemplateButton({ templateId, templateName }: Props) {
  const [state, formAction, isPending] = useActionState(
    async () => {
      ...
      if (!ok) return null;
      return deleteScorecardTemplate(templateId);
    },
    null,
  );
