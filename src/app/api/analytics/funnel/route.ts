...
import { computeFunnelAnalytics } from "@/lib/analytics/compute";

/**
 * GET /api/analytics/funnel
 * Query params: ?from=YYYY-MM-DD&to=YYYY-MM-DD
 * Returns FunnelSnapshot computed live for the date range.
 * D33 §7
 */
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    return problemResponse(500, "ATS-AN02", "Failed to compute funnel analytics");
  }
}
